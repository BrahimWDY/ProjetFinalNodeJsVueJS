    ...
    <div class="head">
        ...
        <div class="container Top50">
            <form>
                ...
                <div class="form-group">
                    <label class="col-form-label" for="inputDefault">Date du début</label>
                    <input type="text" class="form-control" v-model="DateDebut" placeholder="Entrez la date du début du projet. (Exemple : 01/01/1970)" >
                </div>

                <div class="form-group">
                    <label class="col-form-label" for="inputDefault">Date de fin</label>
                ...
                <button type="button" class="btn btn-primary" v-on:click="formData(NomProjet,ProjectDesc, DateDebut, DateFin, MontantTotal, Statut)">Créer</button>
            </form>
        </div>
    </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            formData: function (NomProjet, ProjectDesc, DateDebut, DateFin, MontantTotal, Statut) {
                ProjectsService.createProject(NomProjet, ProjectDesc, DateDebut, DateFin, MontantTotal, Statut)
            }
        }
    }
</script>
